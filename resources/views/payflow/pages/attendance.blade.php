...
<section class="card" style="margin-top:16px;">
    <div class="section-title"><h2>Import CSV Kehadiran</h2><div>@if ($isSuperAdminViewing ?? false)<span class="badge badge-amber" title="Hanya tersedia untuk Tim HR/Finance">View Only</span>@else<button class="btn btn-secondary">@include('payflow.partials.icon', ['name' => 'upload', 'class' => 'icon icon-sm']) Import CSV</button><button class="btn btn-primary">@include('payflow.partials.icon', ['name' => 'lock', 'class' => 'icon icon-sm']) Kunci Periode</button>@endif</div></div>
