<section class="card"
    ...
    <div class="section-title">
        <h2>Edit Karyawan: {{ $employee->name }}</h2>
        <a href="{{ route('employees.show', $employee) }}" class="btn btn-secondary">Lihat Detail</a>
    </div>
        ...
        <form method="POST" action="{{ route('employees.update', $employee) }}" novalidate>
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <input id="nip" name="nip" type="text"
                    ...
                    @blur="onBlur('nip')"
                    @input="onInput('nip')"
                    value="{{ old('nip', $employee->nip) }}" placeholder="EMP-0001" style="max-width:260px;">
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <input id="name" name="name" type="text"
                    ...
                    @blur="onBlur('name')"
                    @input="onInput('name')"
                    value="{{ old('name', $employee->name) }}" placeholder="Nama karyawan" style="max-width:360px;">
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <input id="position" name="position" type="text"
                    ...
                    value="{{ old('position', $employee->position) }}" placeholder="e.g. Software Engineer" style="max-width:260px;">
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <select id="work_status" name="work_status"
                    ...
                    @foreach(['active'=>'Aktif','probation'=>'Probation','contract'=>'Kontrak','inactive'=>'Tidak Aktif'] as $val => $label)
                        <option value="{{ $val }}" {{ old('work_status', $employee->work_status) === $val ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <input id="join_date" name="join_date" type="date"
                    ...
                    value="{{ old('join_date', $employee->join_date?->format('Y-m-d')) }}" style="max-width:200px;">
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <input id="basic_salary" name="basic_salary" type="number" min="0" step="1000"
                    ...
                    value="{{ old('basic_salary', $employee->basic_salary) }}" style="max-width:200px;">
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <select id="bank_account_status" name="bank_account_status"
                    ...
                    @foreach(['verified'=>'Verified','unverified'=>'Unverified','rejected'=>'Rejected'] as $val => $label)
                        <option value="{{ $val }}" {{ old('bank_account_status', $employee->bank_account_status) === $val ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="field" style="margin-bottom:16px;">
                ...
                <input id="bank_account_number" name="bank_account_number" type="text"
                    ...
                    value="{{ old('bank_account_number', $employee->bank_account_number) }}" style="max-width:260px;">
            ...
            <div class="field" style="margin-bottom:24px;">
                ...
                <input id="bank_name" name="bank_name" type="text"
                    ...
                    value="{{ old('bank_name', $employee->bank_name) }}" style="max-width:260px;">
