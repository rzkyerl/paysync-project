...
<section class="card" style="margin-top:16px;">
    <div class="section-title"><h2>Penyaluran Gaji</h2>@if ($isSuperAdminViewing ?? false)<span class="badge badge-amber" title="Hanya tersedia untuk Tim HR/Finance">View Only</span>@else<button class="btn btn-primary">Buat Batch Transfer</button>@endif</div>
