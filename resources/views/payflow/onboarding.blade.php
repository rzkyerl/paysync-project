    ...
    <main class="auth-main" style="min-height:100vh; align-items:start; padding-top:36px;">
        <section class="card" style="width:min(980px,100%); padding:24px;">
            ...
            <div class="grid grid-6" style="display:grid; grid-template-columns:repeat(6,1fr); gap:8px; margin-bottom:22px;">
                @foreach (['Profil Perusahaan','Struktur Organisasi','Pengaturan Payroll','Tambah Karyawan','Simulasi Pembayaran','Review'] as $i => $step)
                    <div>
            ...
            <div class="grid grid-2">
                <div>
                    ...
                    <div class="grid">
                        @foreach ([
                            ['Profil','PT Nusantara Demo, Asia/Jakarta, Rupiah'],
                            ['Organisasi','4 departemen, 12 jabatan aktif'],
                            ['Payroll','Cut-off 25, pay date 30, lembur aktif'],
                            ['Karyawan','Gunakan data demo 248 karyawan'],
                            ['Pembayaran','Mock Wallet Payroll Demo, saldo simulasi Rp1.280.000.000'],
                        ] as $row)
                ...
                <div class="card" style="padding:18px; box-shadow:none; align-self:start;">
                    ...
                    <p class="muted">Sistem tidak melakukan transfer nyata. Batch transfer, rekening, saldo, timeout, dan retry hanya berjalan sebagai data dummy untuk demonstrasi.</p>
                    <div class="grid grid-3">
                        <button class="btn btn-secondary">Tambah Manual</button>
                        <button class="btn btn-secondary">Import CSV</button>
                        <button class="btn btn-primary">Gunakan Data Demo</button>
                    </div>
                </div>
            </div>
