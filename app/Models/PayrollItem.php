...
class PayrollItem extends Model
{
    protected $fillable = [
        ...
        'overtime_pay', 'absence_deduction', 'days_present_snapshot', 'work_days_snapshot',
        'bpjs_tk_deduction', 'bpjs_kesehatan_deduction', 'pph21_deduction',
    ...
    protected function casts(): array
    {
        return [
            ...
            'days_present_snapshot'      => 'integer',
            'work_days_snapshot'         => 'integer',
